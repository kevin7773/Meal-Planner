...
Optional recipe photos use the recipe ID as the filename:
...
The initial `FDP-*.jpg` set contains generated placeholders based on each
recipe name. They are deliberately replaceable as real family photos become
available.
